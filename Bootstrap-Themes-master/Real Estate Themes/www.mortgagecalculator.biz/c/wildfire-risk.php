...
<html lang="en">
	<head>
		...
		<title>Getting a Mortgage in a Wildfire Risk Area</title>
    <link rel="icon" href="https://www.mortgagecalculator.biz/favicon.ico" type="image/x-icon" />
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />		<meta name="author" content="Trey Conway">
 	...
 	<body class="hsm">
		...
		<section id="content" class="content-block-outer" role="main">
			<div class="wrapper-new">
				...
				<div class="sidebar-left">
					...
					<div class="sidebar-calculator-block">
						<div class="bankrateWidget" app="oa" kind="tabbed" tabs="mortgage,cd,creditcard,auto" widgetwidth="280" pkey="i01zfw6c7a" fontfamily="arial,sans-serif" linkscolor="#0000ff" titlebarbackgroundcolor="#f1fdeb" activetabbackgroundcolor="#08b5db" nextbuttonbackgroundcolor="#08b5db" pid="orgcalcmortbiz" campaign="mcbside#/c/wildfire-risk.php"></div><script src="//widgets.bankrate.com/booter.js"></script>
					</div>
			...
			<div class="heading-block">
				<div class="main-heading"><h1>Getting a Mortgage in a Wildfire Risk Area</h1>
                </div>
                    <ul id="breadcrumbs">
                        <li><a href="https://www.mortgagecalculator.biz/">Home</a></li>
                        <li><a href="https://www.mortgagecalculator.biz/resources/">Resources</a></li>
                        <li><a href="https://mortgagecalculator.biz/resources/natural-disasters.php">Natural Disasters</a></li>
                        <li>Wildfires</li> 
                  </ul>
                </div>
<div class="bottom-section">
<p>You won't necessarily find it harder to get a mortgage on a home in an area  that's vulnerable to wildfire, but other home-ownership costs might be a bit  more expensive.</p>
<h2>Where are Wildfires a Risk?</h2>
<p>Of the ten most damaging wildfires in US history, eight have occurred in  California. However, while the greatest risk is definitely in the south-west,  and in California in particular, almost all states have some regions where  wildfires are a risk.</p>
<p>According to <a href="http://www.nfpa.org/~/media/Files/Wildland/WildfireWUICaseStudy.pdf">a  report by the USDA</a>, nearly one-third of US homes are located in areas  called &quot;wild-land urban interfaces,&quot; or, areas where houses are built  amongst the natural landscape of trees and shrubs. It's these areas that are  most at risk in hot, dry weather, and the risk is present even in partly urban  areas—a home doesn't have to be situated in the middle of a forest to be  vulnerable. Due to a combination of location and climate, an estimated 4.5  million US homes are highly vulnerable to wildfires.</p>
<p>It should be noted that risk level isn't static; it can change for a variety  of reasons that aren't limited to seasonal factors. It's possible that the  level of risk may increase across the country due to factors relating to  climate change, for example, and in the coming decades, areas where the level  of risk is currently low or moderate may become more vulnerable. Risk level can  also change as a result of rural and urban development, when land is cleared or  partially cleared to provide room for new construction.</p>
<p><img src="../img/wildfire.jpg" width="630" height="473" alt="Wildfire." /></p>
<h2>Does Wildfire Risk Affect Mortgage Eligibility or Cost?</h2>
<p>Buying a home in an area that's vulnerable to wildfires doesn't directly  affect whether or not you can get a mortgage, or how much a mortgage will cost.  After all, if it did, nobody would build, buy, or sell homes in at-risk areas.  There are, however, some instances where wildfire risk might indirectly have a  small effect on your mortgage.</p>
<p>One such instance is the cost of your homeowner's insurance. Getting a  mortgage to buy a home typically involves using the home you're buying as  collateral for the loan. Since the mortgage lender has a hefty financial stake  in the property—up to 95% depending on the size of the down-payment—they  require that the buyer purchases homeowner's insurance to protect against  damage to the property. In most cases a home-buyer is required to pay several  advance insurance payments into the home's escrow account at the time of  closing.</p>
<p>While some types of damage—like earthquake and flood damage, for  example—aren't included in a standard homeowner's insurance policy, fire  damage, including wildfire damage, is included. A standard policy is therefore  all a homeowner needs to provide their property with coverage for wildfires.</p>
<p>The main difference for people in vulnerable areas is that insurance is  likely to be more expensive, due to the increased risk of fire. However,  homeowners can reduce the risk of serious property damage—and reduce their  insurance costs—by taking measures to protect their homes from fire damage, or  purchasing a property that is less vulnerable to damage. For example, homes  that are made from non-flammable materials like stone and brick are much less  vulnerable to complete destruction than homes made from wood. As a result, such  homes typically cost less to insure.</p>
<h2>Where Are Wildfires Most Likely to Occur?</h2>
<p><img src="https://www.mortgagecalculator.biz/img/wildfire-risk.png" width="879" height="659" alt="Risk of Wildfire Damage Across the United States."></p>
<h2>What Happens to Your Mortgage if You're Affected by a Wildfire?</h2>
<p>If your home is damaged by a wildfire, you have several options for dealing  with the aftermath. When the damage is mild to moderate, most homeowners choose  to use the insurance payout to repair the property. However, in cases where a  home is completely destroyed by fire, some people choose to use insurance money  to pay off the outstanding mortgage balance, rather than rebuilding.</p>
<p>Unless a mortgage contract explicitly states otherwise, homeowners have the  freedom to choose between the two options. Some mortgage lenders (or mortgage  servicers, if the mortgage has been sold) pressure homeowners to pay the  mortgage, rather than rebuild, but in most cases homeowners have the option of  rebuilding if they choose to, and can't legally be forced to do otherwise.</p>
<h2>Summary</h2>
<ul class="arrow">
  <li>Most states have regions where there is a risk  of wildfire, but some states, like California, Texas, and Colorado, have  regions where there is a much greater risk</li>
  <li>Risks change due to seasonal factors, as well as  changes in the rural and urban environment, and may also fluctuate in the long  term as a result of climate change</li>
  <li>Wildfire risk doesn't reduce mortgage  eligibility or increase the costs of a mortgage, but it can increase other  costs of home-ownership, such as insurance</li>
  <li>Fire damage is covered by standard homeowner's  insurance</li>
  <li>Since advance insurance payments are required at  closing, home-buyers purchasing a home in an at-risk area will need to come up  with a little more money to cover the higher insurance costs</li>
  <li>When an insured home is destroyed by fire, the  owner can use the insurance money to rebuild, or to repay the mortgage,  depending on the terms of their mortgage contract</li>
</ul> 
