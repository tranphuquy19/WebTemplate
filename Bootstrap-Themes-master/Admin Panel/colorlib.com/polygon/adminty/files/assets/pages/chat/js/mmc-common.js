...
$(document).on('click', '#main-chat #paper-btn', function (e) {
        ...
        _box_message.append('<div class="message out no-avatar media">' +
            ...
            ' <div class="sender media-right friend-box"><a href="javascript:void(0);" title="Me"><img src="../files/assets/images/avatar-1.jpg" class=" img-chat-profile" alt="Me"></a> </div>' +
            '</div>');
