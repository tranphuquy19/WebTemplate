            ...
            <div class="figure-grid">
                <div class="image">
                    <a href="#productid1" class="mfp-open">
                        <img class="tof" src="../<?php echo $p['chemin']?>" alt="" width="360" />
                    </a>
                </div>
                <div class="text">
                    <h2 class="title h4"><a href="product.html"><?php echo $p['libelle']?></a></h2>
                    <sub><?php echo $p['prix']?>MAD</sub>
                    <sup><?php echo $p['prix']-200?></sup>
